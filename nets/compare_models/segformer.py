# --------------------------------------------------------
# References:
# Following: https://github.com/lucidrains/segformer-pytorch/blob/main/segformer_pytorch/segformer_pytorch.py
# --------------------------------------------------------
...
class Segformer(nn.Module):
    ...
    def forward(self, x):
        ...
        return self.up_sample(self.to_segmentation(fused))
